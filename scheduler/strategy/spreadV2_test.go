...
func TestSpreadPlaceV2DifferentNodeSize(t *testing.T) {
	s := &SpreadPlacementV2Strategy{}
...
func TestSpreadPlaceV2DifferentNodeSizeCPUs(t *testing.T) {
	s := &SpreadPlacementV2Strategy{}
...
func TestSpreadPlaceV2EqualWeight(t *testing.T) {
	s := &SpreadPlacementV2Strategy{}
...
func TestSpreadPlaceV2ContainerMemory(t *testing.T) {
	s := &SpreadPlacementV2Strategy{}
...
func TestSpreadPlaceV2ContainerCPU(t *testing.T) {
	s := &SpreadPlacementV2Strategy{}
...
func TestSpreadPlaceV2ContainerHuge(t *testing.T) {
	s := &SpreadPlacementV2Strategy{}
	...
	for i := 0; i < 100; i++ {
		node := selectTopNode(t, s, createConfigV2(0, 1), nodes)
		assert.NoError(t, node.AddContainer(createContainer(fmt.Sprintf("c%d", i), createConfigV2(0, 1))))
	}
	...
	for i := 100; i < 200; i++ {
		node := selectTopNode(t, s, createConfigV2(1, 0), nodes)
		assert.NoError(t, node.AddContainer(createContainer(fmt.Sprintf("c%d", i), createConfigV2(1, 0))))
	}

	// try to add another container 1G
	_, err = s.RankAndSort(createConfigV2(1, 0), nodes)
	assert.Error(t, err)
}

func TestSpreadPlaceV2ContainerOvercommit(t *testing.T) {
	s := &SpreadPlacementV2Strategy{}
...
func TestSpreadV2ComplexPlacement(t *testing.T) {
	s := &SpreadPlacementV2Strategy{}
